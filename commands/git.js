...
const exampleEmbed = new EmbedBuilder()
	...
	.addFields(
        { name: '\u200B', value: '\u200B' },
		{ name: '$ git init [nome-do-projeto]', value: 'Cria um novo reposítório local com um nome especificado', inline: true },
        ...
        { name: '$ git commit -m "[messagem]"', value: 'Grava o snapshot permanente do arquivo no histórico de versão', inline: true },
        { name: '\u200B', value: '\u200B' },
        { name: '$ git branch"', value: 'Lista todos os branches locias no repositório atual', inline: true },
        { name: '$ git branch [nome-branch]', value: 'Muda para a branch especificada e atualiza o diretório de trabalho ', inline: true },
